...
% INFO    : AC OPF Solution File:        nesta_case5_pjm.dat.opf.sol
...
% INFO    : Bus 1	: V=1.0, theta=0.0 -> V=1.07762, theta=2.80377
% INFO    : Bus 2	: V=1.0, theta=0.0 -> V=1.08407, theta=-0.73465
% INFO    : Bus 3	: V=1.0, theta=0.0 -> V=1.1, theta=-0.55972
% INFO    : Bus 4	: V=1.0, theta=0.0 -> V=1.06414, theta=0.0
% INFO    : Bus 5	: V=1.0, theta=0.0 -> V=1.06907, theta=3.59033
% INFO    : 
