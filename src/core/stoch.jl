...
"""
    This is a small function that writes out the scnearios in json file format
    Only writes the SS & SLR information from the model. Following the same indexing from the type.
"""
...
"""
    This is a small function that takes a user-defined(size/sepecific) subset of an existing stocType
    Input : stoc::stocType | subset::Array/Int | driver
"""
...
"""
    Provides more flexibility in composing different scenarios.
    Load this script during the DEBUGGING mode for functionalities.
"""
...
"""
    If I don't have to do this, I won't do this.
    Understanding how julia handle all these pointers is very important
"""
